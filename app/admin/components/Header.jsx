...
export default function Header({ session }) {
    ...
    return (
        <>
            <header id="site-header" className="flex justify-between items-center py-4 px-2">
                <div className="logo-area">
                    <Link href="/admin" className="flex text-xl gap-2">
                ...
                <div className="header-right flex items-center gap-3">
                    ...
                    <Link className="logout bg-red-500 px-2 py-1 rounded-md text-sm flex gap-2 items-center" href="/api/auth/signout">
                        Sign Out
